...
alias redrip="sauce && ~/dev/sauce/sandbox/joe/redrip.py"
...
export PATH=$PATH:/Users/joe/bin:/opt/local/bin:$EC2_HOME/bin:/usr/local/lib/node_modules/coffee-script/bin/:$HOME/Library/Haskell/bin:/Library/Haskell/bin
